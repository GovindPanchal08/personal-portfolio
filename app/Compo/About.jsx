    ...
    <>
      {showAbout && (
        <div className="fixed inset-0   bg-black/80 backdrop-blur-md flex items-center justify-center z-50 p-4">
          <div className="bg-zinc-900/95  backdrop-blur-md border border-zinc-700/50 rounded-3xl p-8 max-w-lg w-full mx-4 animate-fadeInScale">
            ...
            <div className="space-y-4 ">
              ...
              <p className="text-zinc-300 leading-relaxed">
                ...
                interactive web applications using React.js, Javascipt,
                HTML/CSS, and modern frontend practices.
              </p>
              <p className="text-zinc-300 leading-relaxed">
                Recently, I’ve been diving deep into backend development with
                Node.js, Express, and MongoDB, gaining a solid understanding of
                server-side logic, REST APIs, and database integration.
              </p>
              <p className="text-zinc-300 leading-relaxed">
              ...
              <p className="text-zinc-300 leading-relaxed">
                I'm eager to join a dynamic team where I can apply my skills,
                contribute to impactful projects, and continue growing as a
